...
const _excluded$M = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"], _excluded2$5 = ["aria-current", "caseSensitive", "className", "end", "style", "to", "unstable_viewTransition", "children"];
...
const Link = /* @__PURE__ */ reactExports.forwardRef(function LinkWithRef(_ref7, ref) {
  ...
  } = _ref7, rest = _objectWithoutPropertiesLoose$1(_ref7, _excluded$M);
  let {
    basename
  } = reactExports.useContext(NavigationContext);
  let absoluteHref;
...
const NavLink = /* @__PURE__ */ reactExports.forwardRef(function NavLinkWithRef(_ref8, ref) {
  let {
    ...
    unstable_viewTransition,
    children
  } = _ref8, rest = _objectWithoutPropertiesLoose$1(_ref8, _excluded2$5);
...
reactIs_production_min$2.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e$2 || a === m$2 || a === g$2 || a === f$2 || a === p$2 || a === q$2 || "object" === typeof a && null !== a && (a.$$typeof === t$2 || a.$$typeof === r || a.$$typeof === h$2 || a.$$typeof === k$2 || a.$$typeof === n$2 || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v$2);
};
...
const _excluded$I = ["ownerState"], _excluded2$4 = ["variants"], _excluded3$2 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
const defaultTheme$3 = defaultTheme$2;
...
const _excluded$C = ["ownerState"], _excluded2$3 = ["variants"], _excluded3$1 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
function processStyleArg(callableStyle, _ref) {
  ...
  if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
    const {
      variants = []
    } = resolvedStylesArg, otherStyles = _objectWithoutPropertiesLoose(resolvedStylesArg, _excluded2$3);
    let result = otherStyles;
    variants.forEach((variant) => {
      let isMatch = true;
      if (typeof variant.props === "function") {
...
const _excluded$z = ["className", "color", "enableColorOnDark", "position"];
...
const _excluded$m = ["onEntering"], _excluded2$2 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], _excluded3 = ["slotProps"];
...
const Popover = /* @__PURE__ */ reactExports.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded$m), other = _objectWithoutPropertiesLoose(props, _excluded2$2);
...
const _excluded$l = ["onEntering"], _excluded2$1 = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"];
const RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
...
default_1$1 = Menu.default = (0, _createSvgIcon$1.default)(/* @__PURE__ */ (0, _jsxRuntime$1.jsx)("path", {
...
const _excluded$i = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
Object.defineProperty(HourglassTop, "__esModule", {
  value: true
});
var default_1 = HourglassTop.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = jsxRuntimeExports;
default_1 = HourglassTop.default = (0, _createSvgIcon.default)(/* @__PURE__ */ (0, _jsxRuntime.jsx)("path", {
...
function NavBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppBar$1, { position: "static", sx: { backgroundColor: "#0c1f78" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { maxWidth: "xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Toolbar$1, { disableGutters: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { sx: { display: { xs: "none", md: "flex" }, mr: 1 } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { sx: { flexGrow: 1, display: { xs: "flex", md: "none" } }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Menu$2,
        {
          ...
          children: pages.map((page) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem$1, { onClick: handleCloseNavMenu, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button$1,
            {
              component: NavLink,
              to: page.href,
              color: "inherit",
              sx: { width: "100%" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { textAlign: "center", children: page.title })
            }
          ) }, page.title))
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { sx: { display: { xs: "flex", md: "none" }, mr: 1 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Typography$1,
      {
        variant: "h5",
...
axios.default = axios;
const EstablishmentsServiceContext = reactExports.createContext(void 0);
const useEstablishmentsService = () => {
  const context = reactExports.useContext(EstablishmentsServiceContext);
  if (!context) {
    throw new Error(
...
const EstablishmentsServiceProvider = ({
  children
}) => {
  const [selectedCity, setSelectedCity] = reactExports.useState("");
  const [establishments, setEstablishments] = reactExports.useState([]);
  const getEstablishmentsByCity = reactExports.useCallback(async (city) => {
    try {
      setEstablishments([]);
...
const city1 = "/assets/city1-BAswWtOY.jpeg";
const city2 = "/assets/city2-BYekVvmn.jpeg";
const city3 = "/assets/city3-BEKsU_hX.jpeg";
const city4 = "/assets/city4-BwQf0YQ9.jpeg";
const city5 = "/assets/city5-CFMAj-wS.jpeg";
const returnPhotoURL = (photo) => {
  switch (photo) {
    case 1:
      return city1;
    case 2:
...
const useSlideshow = () => {
  const [photo, setPhoto] = reactExports.useState(1);
  reactExports.useEffect(() => {
    const interval = setInterval(() => {
      change();
    }, 5e3);
  ...
  const change = () => {
    setTimeout(() => {
      setPhoto((prev2) => prev2 === 5 ? 1 : prev2 + 1);
    }, 1e3);
  };
...
function SelectCity({ cityChange, pageTitle, text }) {
  const { selectedCity } = useEstablishmentsService();
  const { backgroundImageStyle } = useSlideshow();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { sx: backgroundImageStyle, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "section-title page-title__small", children: pageTitle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title text-shadow", children: text }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: selectedCity, onChange: cityChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select a City" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Miami", children: "Miami" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Los Angeles", children: "Los Angeles" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "New York", children: "New York" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Tampa", children: "Tampa" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Houston", children: "Houston" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Atlanta", children: "Atlanta" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Orlando", children: "Orlando" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Las Vegas", children: "Las Vegas" })
    ] })
  ] }) });
}
const Home = () => {
  const { setSelectedCity, getEstablishmentsByCity } = useEstablishmentsService();
...
function Specials() {
  const { selectedCity, setSelectedCity, getEstablishmentsByCity } = useEstablishmentsService();
  const location = useLocation().pathname;
  const returnSelectCityText = (location2) => {
    switch (location2) {
  ...
  return !selectedCity ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectCity, { cityChange: handleCityChange, pageTitle: "", text: pageTitle }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
}
...
function SpecialInfo({ special, establishmentHasSpecialsNow }) {
  function specialIsOnNow(special2) {
    if (!establishmentHasSpecialsNow)
      return false;
    const startTime = special2.specialHours.startTime;
    let endTime = special2.specialHours.endTime;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box$1,
    {
      className: `special-info ${specialIsOnNow(special) ? "special-on-now" : ""}`,
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: special.specialDescription }),
        special.specialCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "special-category", children: category })),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
      ]
    }
  );
}
function EstablishmentPreview({ day, establishment }) {
  ...
  const currentTime2 = getCurrentTime2();
  const establishmentHasSpecialsNow = (establishment2) => {
    if (day != today)
      return false;
    const specialsToday = establishment2.establishmentSpecials[today];
    if (!specialsToday)
      return false;
    return specialsToday.some((special) => {
      ...
      return currentTime2 >= startTime && currentTime2 <= endTime;
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box$1,
    {
      className: `establishment ${establishmentHasSpecialsNow(establishment) ? "specials-on-now" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "establishment-name", children: establishment.establishmentName }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "establishment-address", children: [
          "Address: ",
          establishment.establishmentAddress
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "specials-label", children: "Specials " }),
        " ",
        establishment.establishmentSpecials[day] ? establishment.establishmentSpecials[day].map((special) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          SpecialInfo,
          {
            special,
...
function EstablishmentsList({ day, establishments }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { children: establishments.map(
    (establishment, estIndex) => establishments ? /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SelectedCity() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: selectedCity }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "section-button__text-only_ghost", onClick: clearCity, children: "Change City" })
  ] });
}
function SpecialsOnNow() {
  ...
  const currentTime2 = getCurrentTime2();
  function getEstablishmentsWithSpecialsNow(establishments2) {
    return establishments2.filter((establishment) => {
  ...
  const establishmentsWithSpecialsNow = getEstablishmentsWithSpecialsNow(establishments);
  console.log(establishmentsWithSpecialsNow);
  const establishmentElements = /* @__PURE__ */ jsxRuntimeExports.jsx(
    EstablishmentsList,
    {
      day: today,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { component: "h1", className: "page-title__small", children: "Specials On Now" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectedCity, {}),
    establishmentsWithSpecialsNow.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: establishmentElements }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { component: "span", className: "section-title no-specials", children: "No Specials On Right Now" })
    ] })
  ] });
}
function SpecialsByDay() {
  const { establishments, getEstablishmentsByCity, selectedCity } = useEstablishmentsService();
  const daysOfWeek = [
    "Sunday",
    "Monday",
    "Tuesday",
  ...
  const [value, setValue] = reactExports.useState((/* @__PURE__ */ new Date()).getDay());
  const [day, setDay] = reactExports.useState(getTodaysDayOfWeek());
  const [loading, setLoading] = reactExports.useState(true);
  const filterEstablishmentsWithSpecialsOnDay = (establishments2, day2) => {
    return establishments2.filter((establishment) => {
      const specialsToday = establishment.establishmentSpecials[day2];
  ...
  if (loading) {
    establishmentsDisplay = /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Loading..." });
  }
  establishmentsDisplay = /* @__PURE__ */ jsxRuntimeExports.jsx(
    EstablishmentsList,
    {
      day,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { component: "h1", className: "page-title__small", children: "Specials By Day" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectedCity, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppBar$1, { className: "day-navbar", position: "static", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs$1, { value, onChange: handleChange, children: daysOfWeek.map((day2, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tab$1, { label: day2 }, index)) }) }),
    establishmentsWithSpecialsByDay.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: establishmentsDisplay }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography$1, { component: "span", className: "section-title no-specials", children: [
      "No Specials On ",
      day
    ] })
  ] });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { id: "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { children: "©2024 Find Happy Hour" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-un-styled footer-nav", children: [
...
function LoginForm() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { className: "section-title", component: "h1", variant: "h5", children: "Sign in" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "", noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextField$1,
        {
          variant: "outlined",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { component: NavLink, to: "/login?login=register", className: "", children: "Don't have an account? Register" })
    ] })
  ] });
}
function RegistrationForm() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { className: "section-title", component: "h1", variant: "h5", children: "Register" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "", noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextField$1,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { maxWidth: "xs", className: "register-link-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { component: NavLink, to: "/login", className: "", children: "Already have an account? Login" }) })
    ] })
  ] });
}
function useQuery() {
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Container$1,
    {
      ...
      className: "",
      sx: { margin: "auto" },
      children: login != "register" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoginForm, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(RegistrationForm, {})
    }
  );
}
function RegistrationPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { component: "main", maxWidth: "xs", className: "", sx: { margin: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RegistrationForm, {}) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BrowserRouter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: "specials", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Specials, {}), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "on-now", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecialsOnNow, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "by-day", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecialsByDay, {}) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "login", element: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "register", element: /* @__PURE__ */ jsxRuntimeExports.jsx(RegistrationPage, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EstablishmentsServiceProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
